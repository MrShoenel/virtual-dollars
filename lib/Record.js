...
class Record {
    ...
    constructor(line, nameMapper, integerAmountOnly = false, trimTrailingCommas = true) {
        ...
        this._name = this._selfReport ?
            'ME' : nameMapper.getMatchedName(sp[0].split(/\s+/).join(' '));
    ...
    toString() {
        return `[Amount: ${this.amount}, Scrums missed: ${this.scrumsMissed}, Other Missed: ${this.otherMissed}, is Scrum Master: ${this.isScrumMaster}, is self-report: ${this.isSelfReport}, for: ${this.name}]`;
    };
